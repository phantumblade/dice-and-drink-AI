...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white border-t-2 border-black text-black py-10 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t-2 border-black pt-6 mt-6 text-center text-[11px] md:text-xs font-bold uppercase tracking-[0.18em] opacity-60">
