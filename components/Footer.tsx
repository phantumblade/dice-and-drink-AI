        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col items-start">
             ...
             <div className="flex space-x-4">
                <a href="#" className="p-2 border-2 border-black shadow-neo hover:translate-y-1 hover:shadow-none hover:bg-black hover:text-white transition-all"><Github className="w-5 h-5" /></a>
                <a href="#" className="p-2 border-2 border-black shadow-neo hover:translate-y-1 hover:shadow-none hover:bg-neo-cyan hover:text-white transition-all"><Twitter className="w-5 h-5" /></a>
